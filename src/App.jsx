  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-white to-slate-100 text-slate-900 p-6 md:p-10">
      <div className="max-w-6xl mx-auto grid gap-6">
        <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} className="rounded-3xl border border-slate-200 bg-white/90 shadow-xl p-6 md:p-8">
          <div>
        ...
        <div className="grid lg:grid-cols-[1.1fr_0.9fr] gap-6">
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.05 }} className="rounded-3xl border border-slate-200 bg-white shadow-lg p-6">
            ...
            <div className="mt-5 grid gap-4">
              <div>
                ...
                <div className="mt-2 flex gap-2 flex-wrap">
                  <button onClick={() => setMode("smart")} className={`rounded-2xl px-4 py-2 border transition ${mode === "smart" ? "border-slate-900 bg-slate-900 text-white" : "border-slate-300 bg-white text-slate-700"}`}>Smart detect</button>
              ...
              {mode === "header" && (
                <div>
                  ...
                  <input value={headerName} onChange={(e) => setHeaderName(e.target.value)} className="mt-2 w-full rounded-2xl border border-slate-300 px-4 py-3 outline-none focus:ring-2 focus:ring-slate-300" placeholder="Example: PREMISES" />
                </div>
              )}
              ...
              <button onClick={handleDownload} disabled={!canDownload} className="inline-flex items-center justify-center gap-2 rounded-2xl bg-slate-900 px-5 py-3 text-white font-medium disabled:opacity-40 disabled:cursor-not-allowed">
          ...
          <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.1 }} className="rounded-3xl border border-slate-200 bg-white shadow-lg p-6">
            ...
            <div className="mt-5 rounded-2xl bg-slate-50 border border-slate-200 p-4">
              ...
              <div className="mt-3 grid md:grid-cols-3 gap-3 text-sm">
                <div className="rounded-2xl bg-white border border-slate-200 p-3"><div className="text-slate-500">Parsed Address</div><div className="mt-1 font-medium">234 LOR 8 TOA PAYOH</div></div>
